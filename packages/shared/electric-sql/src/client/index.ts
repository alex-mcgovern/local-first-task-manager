...
export const TasksWhereInputSchema: z.ZodType<Prisma.TasksWhereInput> = z
	.object({
		...
		due_date: z
			...
			.nullable(),
		priority: z
			.union([z.lazy(() => Enumtask_priorityFilterSchema), z.lazy(() => task_prioritySchema)])
			.optional(),
	})
	.strict();
...
export const TasksScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TasksScalarWhereWithAggregatesInput> =
	z
		.object({
			...
			priority: z
				.union([
					z.lazy(() => Enumtask_priorityWithAggregatesFilterSchema),
					z.lazy(() => task_prioritySchema),
				])
				.optional(),
		})
		.strict();
...
export const TasksUpdateInputSchema: z.ZodType<Prisma.TasksUpdateInput> = z
	.object({
		...
		priority: z
			.union([
				z.lazy(() => task_prioritySchema),
				z.lazy(() => Enumtask_priorityFieldUpdateOperationsInputSchema),
			])
			.optional(),
	})
	.strict();
...
export const Enumtask_priorityFilterSchema: z.ZodType<Prisma.Enumtask_priorityFilter> = z
	.object({
		equals: z.lazy(() => task_prioritySchema).optional(),
		in: z
			.lazy(() => task_prioritySchema)
			.array()
			.optional(),
		notIn: z
			.lazy(() => task_prioritySchema)
		...
		not: z
			.union([
				z.lazy(() => task_prioritySchema),
				z.lazy(() => NestedEnumtask_priorityFilterSchema),
			])
			.optional(),
	})
	.strict();
...
export const Enumtask_priorityWithAggregatesFilterSchema: z.ZodType<Prisma.Enumtask_priorityWithAggregatesFilter> =
	z
		.object({
			equals: z.lazy(() => task_prioritySchema).optional(),
			in: z
			...
			not: z
				.union([
					z.lazy(() => task_prioritySchema),
					z.lazy(() => NestedEnumtask_priorityWithAggregatesFilterSchema),
				])
				.optional(),
			_count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const Enumtask_priorityFieldUpdateOperationsInputSchema: z.ZodType<Prisma.Enumtask_priorityFieldUpdateOperationsInput> =
	z
		.object({
...
export const NestedEnumtask_priorityFilterSchema: z.ZodType<Prisma.NestedEnumtask_priorityFilter> =
	z
		.object({
			equals: z.lazy(() => task_prioritySchema).optional(),
			in: z
...
export const NestedEnumtask_priorityWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumtask_priorityWithAggregatesFilter> =
	z
		.object({
			equals: z.lazy(() => task_prioritySchema).optional(),
			in: z
