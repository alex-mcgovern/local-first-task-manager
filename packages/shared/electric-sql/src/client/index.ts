...
export const TasksScalarFieldEnumSchema = z.enum(['id','title','description','status','created_at','updated_at','due_date','priority']);

export const TransactionIsolationLevelSchema = z.enum(['ReadUncommitted','ReadCommitted','RepeatableRead','Serializable']);

export const task_prioritySchema = z.enum(['p0','p1','p2','p3']);

export type task_priorityType = `${z.infer<typeof task_prioritySchema>}`
...
export const TasksWhereInputSchema: z.ZodType<Prisma.TasksWhereInput> = z.object({
  ...
  priority: z.union([ z.lazy(() => Enumtask_priorityFilterSchema),z.lazy(() => task_prioritySchema) ]).optional(),
}).strict();
...
export const TasksScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TasksScalarWhereWithAggregatesInput> = z.object({
  ...
  priority: z.union([ z.lazy(() => Enumtask_priorityWithAggregatesFilterSchema),z.lazy(() => task_prioritySchema) ]).optional(),
}).strict();
...
export const TasksCreateInputSchema: z.ZodType<Prisma.TasksCreateInput> = z.object({
  ...
  priority: z.lazy(() => task_prioritySchema)
}).strict();
...
export const TasksUpdateInputSchema: z.ZodType<Prisma.TasksUpdateInput> = z.object({
  ...
  priority: z.union([ z.lazy(() => task_prioritySchema),z.lazy(() => Enumtask_priorityFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();
...
export const Enumtask_statusFilterSchema: z.ZodType<Prisma.Enumtask_statusFilter> = z.object({
  equals: z.lazy(() => task_statusSchema).optional(),
  in: z.lazy(() => task_statusSchema).array().optional(),
  notIn: z.lazy(() => task_statusSchema).array().optional(),
  not: z.union([ z.lazy(() => task_statusSchema),z.lazy(() => NestedEnumtask_statusFilterSchema) ]).optional(),
}).strict();
...
export const Enumtask_priorityFilterSchema: z.ZodType<Prisma.Enumtask_priorityFilter> = z.object({
  equals: z.lazy(() => task_prioritySchema).optional(),
  in: z.lazy(() => task_prioritySchema).array().optional(),
  notIn: z.lazy(() => task_prioritySchema).array().optional(),
  not: z.union([ z.lazy(() => task_prioritySchema),z.lazy(() => NestedEnumtask_priorityFilterSchema) ]).optional(),
}).strict();
...
export const Enumtask_statusWithAggregatesFilterSchema: z.ZodType<Prisma.Enumtask_statusWithAggregatesFilter> = z.object({
  equals: z.lazy(() => task_statusSchema).optional(),
  in: z.lazy(() => task_statusSchema).array().optional(),
  notIn: z.lazy(() => task_statusSchema).array().optional(),
  not: z.union([ z.lazy(() => task_statusSchema),z.lazy(() => NestedEnumtask_statusWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
...
export const Enumtask_priorityWithAggregatesFilterSchema: z.ZodType<Prisma.Enumtask_priorityWithAggregatesFilter> = z.object({
  equals: z.lazy(() => task_prioritySchema).optional(),
  in: z.lazy(() => task_prioritySchema).array().optional(),
  notIn: z.lazy(() => task_prioritySchema).array().optional(),
  not: z.union([ z.lazy(() => task_prioritySchema),z.lazy(() => NestedEnumtask_priorityWithAggregatesFilterSchema) ]).optional(),
  _count: z.lazy(() => NestedIntFilterSchema).optional(),
  _min: z.lazy(() => NestedEnumtask_priorityFilterSchema).optional(),
  _max: z.lazy(() => NestedEnumtask_priorityFilterSchema).optional()
}).strict();
...
export const Enumtask_statusFieldUpdateOperationsInputSchema: z.ZodType<Prisma.Enumtask_statusFieldUpdateOperationsInput> = z.object({
...
export const Enumtask_priorityFieldUpdateOperationsInputSchema: z.ZodType<Prisma.Enumtask_priorityFieldUpdateOperationsInput> = z.object({
  set: z.lazy(() => task_prioritySchema).optional()
}).strict();
...
export const NestedEnumtask_statusFilterSchema: z.ZodType<Prisma.NestedEnumtask_statusFilter> = z.object({
  equals: z.lazy(() => task_statusSchema).optional(),
  in: z.lazy(() => task_statusSchema).array().optional(),
  notIn: z.lazy(() => task_statusSchema).array().optional(),
  not: z.union([ z.lazy(() => task_statusSchema),z.lazy(() => NestedEnumtask_statusFilterSchema) ]).optional(),
...
export const NestedEnumtask_priorityFilterSchema: z.ZodType<Prisma.NestedEnumtask_priorityFilter> = z.object({
  equals: z.lazy(() => task_prioritySchema).optional(),
  in: z.lazy(() => task_prioritySchema).array().optional(),
  notIn: z.lazy(() => task_prioritySchema).array().optional(),
  not: z.union([ z.lazy(() => task_prioritySchema),z.lazy(() => NestedEnumtask_priorityFilterSchema) ]).optional(),
...
export const NestedEnumtask_statusWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumtask_statusWithAggregatesFilter> = z.object({
  equals: z.lazy(() => task_statusSchema).optional(),
  in: z.lazy(() => task_statusSchema).array().optional(),
  notIn: z.lazy(() => task_statusSchema).array().optional(),
  not: z.union([ z.lazy(() => task_statusSchema),z.lazy(() => NestedEnumtask_statusWithAggregatesFilterSchema) ]).optional(),
...
export const NestedEnumtask_priorityWithAggregatesFilterSchema: z.ZodType<Prisma.NestedEnumtask_priorityWithAggregatesFilter> = z.object({
  equals: z.lazy(() => task_prioritySchema).optional(),
  in: z.lazy(() => task_prioritySchema).array().optional(),
  notIn: z.lazy(() => task_prioritySchema).array().optional(),
  not: z.union([ z.lazy(() => task_prioritySchema),z.lazy(() => NestedEnumtask_priorityWithAggregatesFilterSchema) ]).optional(),
