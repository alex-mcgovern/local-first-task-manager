...
export namespace Prisma {
  ...
  */
	...
	export type TasksGetPayload<S extends boolean | null | undefined | TasksArgs> = S extends {
		select: any;
		include: any;
	}
		? "Please either choose `select` or `include`"
			...
			: S extends undefined
				...
				: S extends { include: any } & (TasksArgs | TasksFindManyArgs)
					...
					: S extends { select: any } & (TasksArgs | TasksFindManyArgs)
						? {
								[P in TruthyKeys<S["select"]>]: P extends keyof Tasks
									? Tasks[P]
									: never;
							}
						: Tasks;
	...
	> {
		 ...
		 **/
		findUnique<
			T extends TasksFindUniqueArgs,
			LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
				? T["rejectOnNotFound"]
				: undefined,
		>(
			args: SelectSubset<T, TasksFindUniqueArgs>,
		): HasReject<GlobalRejectSettings, LocalRejectSettings, "findUnique", "Tasks"> extends True
			? Prisma__TasksClient<TasksGetPayload<T>>
			: Prisma__TasksClient<TasksGetPayload<T> | null, null>;
		 ...
		 **/
		findFirst<
			T extends TasksFindFirstArgs,
			LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound
				? T["rejectOnNotFound"]
				: undefined,
		>(
			args?: SelectSubset<T, TasksFindFirstArgs>,
		): HasReject<GlobalRejectSettings, LocalRejectSettings, "findFirst", "Tasks"> extends True
			? Prisma__TasksClient<TasksGetPayload<T>>
			: Prisma__TasksClient<TasksGetPayload<T> | null, null>;
		...
		aggregate<T extends TasksAggregateArgs>(
			args: Subset<T, TasksAggregateArgs>,
		): PrismaPromise<GetTasksAggregateType<T>>;
		...
		>(
			args: SubsetIntersection<T, TasksGroupByArgs, OrderByArg> & InputErrors,
		): {} extends InputErrors ? GetTasksGroupByPayload<T> : PrismaPromise<InputErrors>;
	}
	...
	export type TasksWhereInput = {
		...
		priority?: Enumtask_priorityFilter | task_priority;
	};
	...
	export type TasksScalarWhereWithAggregatesInput = {
		...
		priority?: Enumtask_priorityWithAggregatesFilter | task_priority;
	};
	...
	export type TasksUpdateInput = {
		...
		priority?: Enumtask_priorityFieldUpdateOperationsInput | task_priority;
	};
	...
	export type Enumtask_statusFilter = {
		equals?: task_status;
		in?: Enumerable<task_status>;
		notIn?: Enumerable<task_status>;
		not?: NestedEnumtask_statusFilter | task_status;
	};
	...
	export type Enumtask_priorityFilter = {
		equals?: task_priority;
		in?: Enumerable<task_priority>;
		notIn?: Enumerable<task_priority>;
		not?: NestedEnumtask_priorityFilter | task_priority;
	};
	...
	export type Enumtask_statusWithAggregatesFilter = {
		equals?: task_status;
		in?: Enumerable<task_status>;
		notIn?: Enumerable<task_status>;
		not?: NestedEnumtask_statusWithAggregatesFilter | task_status;
		_count?: NestedIntFilter;
		_min?: NestedEnumtask_statusFilter;
		_max?: NestedEnumtask_statusFilter;
	};
	...
	export type Enumtask_priorityWithAggregatesFilter = {
		equals?: task_priority;
		in?: Enumerable<task_priority>;
		notIn?: Enumerable<task_priority>;
		not?: NestedEnumtask_priorityWithAggregatesFilter | task_priority;
		_count?: NestedIntFilter;
		_min?: NestedEnumtask_priorityFilter;
		_max?: NestedEnumtask_priorityFilter;
	};
	...
	export type NestedEnumtask_statusFilter = {
		equals?: task_status;
		in?: Enumerable<task_status>;
		notIn?: Enumerable<task_status>;
		not?: NestedEnumtask_statusFilter | task_status;
	...
	export type NestedEnumtask_priorityFilter = {
		equals?: task_priority;
		in?: Enumerable<task_priority>;
		notIn?: Enumerable<task_priority>;
		not?: NestedEnumtask_priorityFilter | task_priority;
	...
	export type NestedEnumtask_statusWithAggregatesFilter = {
		equals?: task_status;
		in?: Enumerable<task_status>;
		notIn?: Enumerable<task_status>;
		not?: NestedEnumtask_statusWithAggregatesFilter | task_status;
	...
	export type NestedEnumtask_priorityWithAggregatesFilter = {
		equals?: task_priority;
		in?: Enumerable<task_priority>;
		notIn?: Enumerable<task_priority>;
		not?: NestedEnumtask_priorityWithAggregatesFilter | task_priority;
